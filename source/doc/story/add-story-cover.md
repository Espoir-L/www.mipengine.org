...
​	在阅读本篇前，您需要了解什么小故事，如果您还不了解什么是小故事，可以查看[开发小故事前期准备](/doc/story/add-story-before.html)、[小故事的组织结构](/doc/story/story-organization-structure.html)了解基础信息；
...
​ 接下来我们介绍下如何[为小故事添加更多的内容段落](/doc/story/add-story-section.html)。
